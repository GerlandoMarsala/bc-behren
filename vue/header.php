        ...
        <ul class="menu">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu bg-dark">
                    <li><a class="dropdown-item" href="index.php?page=4">PRÉSENTATION DU CLUB</a></li>
                    <li><a class="dropdown-item" href="index.php?page=8">ACTUALITES</a></li>
                    <li><a class="dropdown-item" href="index.php?page=7">COMPÉTITEURS</a></li>
                </ul>
            </div>
