            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                <!-- <form class="form-signin" method="post" action="../controller/traitement_connexion.php"> -->
                  ...
                  <div class="mt-3">
                  <h2 class="h3 font-weight-normal">Connexion</h2>
                  </div>
                  <div class="mt-5">
                  ...
                  <p class="mt-4 text-dark">Vous n'avez pas encore de compte ?<a href="../public/index.php?page=4" style="text-decoration:none" class="text- fw-bold text-black">Créez en un ici !</a></p>
                </form>
