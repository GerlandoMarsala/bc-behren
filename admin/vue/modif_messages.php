...
<div class="containerAdminHome">
    ...
    <div>
        ...
        <h1 class="titlePage"><span class="colorTitleB">M</span>ODIFIER MESSAGES</h1>
        <div class="borderTitlePage"></div>
    </div>
    <div class="container my-3">

        <form method="post" action="../controller/traitement_modif_messages.php" enctype="multipart/form-data">
            <!--  ID ACTUALITE   -->
            <input type="number" name="id_actua" value="<?php echo htmlspecialchars($idMsg, ENT_QUOTES, 'UTF-8'); ?>" hidden="true">
            <!--  ID IMAGES   -->
