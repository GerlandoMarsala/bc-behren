    ...
    <table class="table">
        ...
        <?php foreach ($listeActualites as $actualite) { ?>
            <tr>
                ...
                <td>
                    <a href="index.php?page=4&id_actualite=<?php echo htmlspecialchars($actualite['id_actualite'], ENT_QUOTES, 'UTF-8'); ?>"><i
                                class="fa-solid fa-pen text-dark"></a></td>
                <td>
                    <a href="index.php?page=5&id_actualite=<?php echo htmlspecialchars($actualite['id_actualite'], ENT_QUOTES, 'UTF-8'); ?>"><i
                                class="fa-solid fa-trash text-dark"></a></td>
            </tr>
            <?php
        }
        ?>
